/*
  # Add default affirmations and system user

  1. New Data
    - Create system user for default content
    - Add default affirmations to shared_content table
    - Add is_default flag to identify system content

  2. Changes
    - Create system user in auth.users
    - Add is_default column to shared_content
    - Insert initial affirmations with system user
    - Update RLS policy for viewing default content
*/
